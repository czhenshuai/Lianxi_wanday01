...
public class LunBoActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "GuideActivity";
    /**
     * 功能引导页展示的图片集合
     */
    private static int[] mImageIds = new int[]{
            R.mipmap.b, R.mipmap.c,R.mipmap.e};
    ...
    private void initView() {
        ...
        mBtnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 跳转到主页面
                startActivity(new Intent(LunBoActivity.this, MainActivity.class));
                finish();
            }
        });
    }
